...
OBJECTFILES= \
	...
	${OBJECTDIR}/testeArbreNoeudBinaireRecherche.o
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp2.1

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp2.1: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp2.1 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/testeArbreNoeudBinaireRecherche.o: testeArbreNoeudBinaireRecherche.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testeArbreNoeudBinaireRecherche.o testeArbreNoeudBinaireRecherche.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp2.1
