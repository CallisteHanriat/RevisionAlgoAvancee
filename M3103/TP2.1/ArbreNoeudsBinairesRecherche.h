...
private:
    ...
    void affichePrettyPrintWorker(const NoeudBinaire<TypeInfo>* ptrRac, const string chaine) const;
    void afficheParcoursLargeurWorker(const NoeudBinaire<TypeInfo>* ptrRac) const;
...
public:
    ...
    void affichePrettyPrint() const;
    void afficheParcoursLargeur() const;
