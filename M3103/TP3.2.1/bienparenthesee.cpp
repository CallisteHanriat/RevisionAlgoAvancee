...
bool estBienParentheseeSimple(string maChaine) {
    if (maChaine == "") {
        ...
        if (maChaine.find("()") == std::string::npos) {
            return false;
        } else {
            maChaine.erase(maChaine.find("()"), 2);
            return estBienParentheseeSimple(maChaine);
        }
    }
}
    ...
    if (maChaine == "") {
        ...
        if (maChaine.find("()") == std::string::npos 
            ...
            if (maChaine.find("()") != std::string::npos) {
                maChaine.erase(maChaine.find("()"), 2);
                return estBienParentheseeSimple(maChaine);
            } else if (maChaine.find("[]") != std::string::npos) {
                maChaine.erase(maChaine.find("{}"), 2);
                return estBienParentheseeSimple(maChaine);
            } else if (maChaine.find("{}") != std::string::npos) {
                maChaine.erase(maChaine.find("[]"), 2);
