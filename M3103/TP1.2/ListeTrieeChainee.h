...
private:
    ...
    int compteNbOccInfoIterWorker(const Cellule<TypeInfo>* ptrCetteListe, TypeInfo& uneInfo);
...
public:
    ...
    // retourne le nombre d’occurrences de uneInfo dans cetteListeChaineeTriee
