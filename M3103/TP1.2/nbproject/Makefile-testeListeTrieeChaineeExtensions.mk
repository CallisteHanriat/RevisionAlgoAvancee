...
CND_DLIB_EXT=so
CND_CONF=testeListeTrieeChaineeExtensions
CND_DISTDIR=dist
CND_BUILDDIR=build
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp1.2

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp1.2: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp1.2 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/ListeTrieeChainee.h.gch: ListeTrieeChainee.h 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o "$@" ListeTrieeChainee.h
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp1.2
