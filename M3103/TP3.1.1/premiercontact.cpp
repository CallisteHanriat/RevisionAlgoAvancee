...
int main() {
    ...
    forward_list<string> maListe {"cinq", "quatre", "trois", "deux", "un", "zéro"};
    ...
    maListe.push_front("zéro");
    maListe.push_front("un");
    maListe.push_front("deux");
    maListe.push_front("trois");
    maListe.push_front("quatre");
    maListe.push_front("cinq");
    ...
    insereInfoAtPosit(maListe, 2, "six_cing");
    ...
    insereInfoAtPosit(maListe, 9, "rien");
    cout << "- La liste devrait contenir six six_cinq cinq quatre trois deux un zéro" << endl;
    cout << "- La liste contient -> ";
    affiche(maListe);
    ...
    try {
        ...
        insereInfoAtPosit(maListe, 11, "rien");
    } catch (PrecondVioleeExcep e) {
